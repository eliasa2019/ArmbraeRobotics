...
* https://bit.ly/2SjcWjz for visual representation, where the x-axis is how far you push the joystick and the y-axis
...
/* SCOOP DRIVE
* Defines the way power gets delivered to the scoop motor
*/
void scoopDrive() {
	if (vexRT[Btn5U] == 1) {
		motor[scoopMotor] = 25;
